...
public class RoleResource {
    ...
    @PostMapping
    public ResponseEntity<Void> create(@RequestBody RoleDto roleDto, UriComponentsBuilder uriBuilder){
        Long idRole = service.Save(roleDto);
        URI uri = uriBuilder.path("/roles/{id}").buildAndExpand(idRole).toUri();
