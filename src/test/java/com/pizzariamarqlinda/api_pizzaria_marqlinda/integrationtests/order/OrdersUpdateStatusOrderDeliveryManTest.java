...
@DirtiesContext
public class OrdersUpdateStatusOrderDeliveryManTest {
    ...
    @Test
    public void shouldUpdateTheOrder_WhenOrderStatusInOutForDeliveryForOutForDelivery(){
        ...
        String tokenChef = MockOrdersCommonUserAll.saveUserDeliveryManAndReturnToken1();
        Response response = given()
                .contentType(ContentType.JSON)
                .header("Authorization", "Bearer "+tokenChef)
                .body(Map.of("status", StatusOrderEnum.ORDER_OUT_FOR_DELIVERY.getName()))
                .when()
                .put("/api/orders/10")
                .then()
                .log().all()
        ...
        //Asserts
        assertEquals("ORDER_OUT_FOR_DELIVERY", status);
        assertNotNull(id);
    }

    @Test
    public void shouldUpdateTheOrder_WhenOrderStatusOrderOutForDeliveryForOrderDelivered(){
        String tokenUser1 = MockOrdersCommonUserAll.saveUserCommon1AndReturnToken();
        String tokenUser2 = MockOrdersCommonUserAll.saveUserCommon2AndReturnToken();
        ...
        Response response = given()
                .contentType(ContentType.JSON)
                .header("Authorization", "Bearer "+tokenChef)
                .body(Map.of("status", StatusOrderEnum.ORDER_DELIVERED.getName()))
                .when()
                .put("/api/orders/11")
                .then()
                .log().all()
        ...
        Long id = response.jsonPath().getLong("id");
        //Asserts
        assertEquals("ORDER_DELIVERED", status);
        assertNotNull(id);
    }

    @Test
    public void shouldReturnPROBLEM_WITH_DELIVERY_WhenDeliveryManUpdate(){
        String tokenUser1 = MockOrdersCommonUserAll.saveUserCommon1AndReturnToken();
        String tokenUser2 = MockOrdersCommonUserAll.saveUserCommon2AndReturnToken();
        ...
        String tokenDelivery = MockOrdersCommonUserAll.saveUserDeliveryManAndReturnToken1();
        Response response = given()
                .contentType(ContentType.JSON)
                .header("Authorization", "Bearer "+tokenDelivery)
                .body(Map.of("status", StatusOrderEnum.PROBLEM_WITH_DELIVERY.getName()))
                .when()
                .put("/api/orders/12")
                .then()
                .log().all()
        ...
        Long id = response.jsonPath().getLong("id");
        //Asserts
        assertEquals("PROBLEM_WITH_DELIVERY", status);
        assertNotNull(id);
    }
