...
@DirtiesContext
public class OrdersUpdateStatusOrderChefTest {
    ...
    public void shouldUpdateTheOrder_WhenValidOperation(){
       ...
       Response response = given()
               ...
               .body(Map.of("status", StatusOrderEnum.ORDER_IN_PROGRESS.getName()))
       .when()
               .put("/api/orders/1")
       .then()
               .log().all()
        ...
        //Asserts
        assertEquals("ORDER_IN_PROGRESS", status);
        assertNotNull(id);
    }

    @Test
    public void shouldUpdateTheOrder_WhenUpdateOrderInProgressForDelivery(){
        String tokenUser1 = MockOrdersCommonUserAll.saveUserCommon1AndReturnToken();
        String tokenUser2 = MockOrdersCommonUserAll.saveUserCommon2AndReturnToken();
    ...
    @Test
    public void shouldReturnErrorOperationNotPermitted_WhenDeliveryManUpdateInvalidStatus(){
        String tokenUser1 = MockOrdersCommonUserAll.saveUserCommon1AndReturnToken();
        String tokenUser2 = MockOrdersCommonUserAll.saveUserCommon2AndReturnToken();
